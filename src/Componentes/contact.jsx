...
function Contact(){
  ...
  return(
    <section className="container" style={{ display: 'flex', alignItems: 'center', width:'max-content', marginLeft: '300px', marginTop:'-330px' }}>
      <div style={{width:'1032px'}} className="row">
      <div className="col-lg-4" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '20px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ color: 'black', width: '10px' }}>3364631890</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <span style={{ color: 'black', width: '10px' }}>Maria Teresa Gutierrez</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        <a href="http://" target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon className="iconosRedes" icon={faInstagram} style={iconStyle} />
        </a>
        <span style={{ color: 'black', width: '10px' }}>@Marite.gutierrezph</span>
      </div>
    </div>
